package com.alta.accessbiometric
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSave.setOnClickListener {
            ...
            //2
            editor.putString("Nombre", etName.text.toString())
            editor.putString("Correo", etEmail.text.toString())
            editor.putString("Télefono", etPhone.text.toString())
            //3
            editor.apply()
            //4
            etName.setText("")
        ...
        etEmail.setText(sharedPreferences.getString("Correo", ""))
        etPhone.setText(sharedPreferences.getString("Télefono", ""))
    }
